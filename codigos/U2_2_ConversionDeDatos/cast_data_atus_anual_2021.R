...
### DELETE USELESS COLUMS AGAIN...
#atus_anual_2021_merge <- select(atus_anual_2021_merge,-MM)
...
### CHANGE COLUMNS
atus_anual_2021_merge$ID_DIA <- atus_anual_2021_merge$DESC_DIA
atus_anual_2021_merge <- select(atus_anual_2021_merge,-DESC_DIA)
...
### CHANGE COLUMNS
atus_anual_2021_merge$ID_HORA <- atus_anual_2021_merge$DESC_HORA
atus_anual_2021_merge <- select(atus_anual_2021_merge,-DESC_HORA)
...
### CHANGE COLUMNS
atus_anual_2021_merge$ID_MINUTO <- atus_anual_2021_merge$DESC_MINUTO
atus_anual_2021_merge <- select(atus_anual_2021_merge,-DESC_MINUTO)
...
### CHANGE COLUMNS
atus_anual_2021_merge$ID_EDAD <- atus_anual_2021_merge$DESC_EDAD
atus_anual_2021_merge <- select(atus_anual_2021_merge,-DESC_EDAD)
