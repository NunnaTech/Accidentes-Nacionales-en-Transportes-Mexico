atus_anual_2020 = read_csv(file = ".//conjunto_de_datos//datos_tratados//atus_2020.CSV")
...
ggplot(data = accidentes_por_tipo,
  ...
  geom_text(aes(label = paste(total), text = element_text(size = 15) ), hjust = 0.5, vjust = 0) +
  theme_minimal() +
